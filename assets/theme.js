  ...
  theme.headerSearch = (function() {
    ...
    function predictQuery(q) {
      ...
      var searchObj = {
        ...
        'resources[options][fields]': 'title,product_type,vendor'
      };
    ...
    Recommendations.prototype = Object.assign({}, Recommendations.prototype, {
      init: function() {
        ...
        fetch(url).then(function(response) {
          ...
          function stepheight(){
            var _stepblock = 0;  
            $('.product-recommendations-slider .slider_prod .grid-item__meta').removeAttr('style');  
            $('.product-recommendations-slider .slider_prod .grid-item__meta').each(function(){      
              if($(this).height() > _stepblock){        
                _stepblock = $(this).height();      
              }  
            });  
            $('.product-recommendations-slider .slider_prod .grid-item__meta').css('height',_stepblock);
          }
	  stepheight();		
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      updateCartButton: function(evt) {
        ...
        var cartBtnText = this.container.querySelector(this.selectors.addToCartText);
  		var notifyme = this.container.querySelector(this.selectors.notifyme);
        if (variant) {
          if (variant.available) {
            ...
            if(notifyme != null){
              notifyme.classList.remove(classes.disabled);
            }
          } else {
            ...
            if(notifyme != null){
          	notifyme.classList.add(classes.disabled);
            }
          }
        } else {
...
//     if (pathlink.includes("#youtuberev")) {
//       console.log(1231213);
//       document.getElementById("youtuberev").querySelector('button').click();
//     }
  });
...
function stepheight2(){
  var _stepblock2 = 0;  
  $('.more-products-slider .slider_prod .grid-item__meta').removeAttr('style');  
  $('.more-products-slider .slider_prod .grid-item__meta').each(function(){      
    if($(this).height() > _stepblock2){        
      _stepblock2 = $(this).height();      
    }  
  });  
  $('.more-products-slider .slider_prod .grid-item__meta').css('height',_stepblock2);
}
...
$(document).on('mouseenter',".cart-recommendations .grid-product__colors .color-swatch--with-image",function() {
  $('.grid-product__color-image').removeClass('is-active');
  var varid = ".grid-product__color-image--" + $(this).data('variant-id');
  var varimg = $(this).data('bgset');
  $(varid).addClass('is-active');
  $(varid).css('background-image','url("'+varimg+'")');
})
.on('mouseleave',".cart-recommendations .grid-product__colors .color-swatch--with-image",function() {
  $('.grid-product__color-image').removeClass('is-active');
});

$(document).on('mouseenter',".recently-viewed-sec .grid-product__colors .color-swatch--with-image",function() {
  $('.grid-product__color-image').removeClass('is-active');
  var varid = ".grid-product__color-image--" + $(this).data('variant-id');
  var varimg = $(this).data('bgset');
  $(varid).addClass('is-active');
...
.on('mouseleave',".recently-viewed-sec .grid-product__colors .color-swatch--with-image",function() {
  $('.grid-product__color-image').removeClass('is-active');
});

$(document).on('mouseenter',".product-recommendations .grid-product__colors .color-swatch--with-image",function() {
  $('.grid-product__color-image').removeClass('is-active');
  var varid = ".grid-product__color-image--" + $(this).data('variant-id');
  var varimg = $(this).data('variant-image');
  $(varid).addClass('is-active');
  $(varid).css('background-image','url("'+varimg+'")');
})
.on('mouseleave',".product-recommendations .grid-product__colors .color-swatch--with-image",function() {
  $('.grid-product__color-image').removeClass('is-active');
});
